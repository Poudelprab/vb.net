...
Public Class studentform
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            Con.open()
            Using command As New SqlCommand("[dbo].[usp_u_semester]", con)
                command.Parameters.AddWithValue("@Department", ComboBox2.Text())
                command.Parameters.AddWithValue("@CurrentSemester", ComboBox1.Text())
                command.CommandType = CommandType.StoredProcedure
                command.ExecuteNonQuery()
            End Using
            GetData()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            con.Open()
            Using command As New SqlCommand("[dbo].[usp_d_semester]", con)
                command.Parameters.AddWithValue("@Department", ComboBox2.Text())
                command.Parameters.AddWithValue("@semester", ComboBox1.Text())
                command.CommandType = CommandType.StoredProcedure
                command.ExecuteNonQuery()
